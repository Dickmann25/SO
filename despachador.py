...
class Despachador:
    ...
    def load_processes(self):
        ...
        for pid, line in enumerate(lines):
            ...
            if prioridade == 0 and blocos_mem > 64:
                ...
                with self.semaforo_print:
                    print(f"\n[ERROR] Processo real possui tamanho {blocos_mem}, mas o espaco de memoria reservado para processos reais e 64, entrada {contador} foi descartada do arquivo processes.txt.")
                continue
    ...
    def load_filesystem(self):
        ...
        # Carrega segmentos já existentes no disco
